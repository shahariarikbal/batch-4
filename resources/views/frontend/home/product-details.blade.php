                                                ...
                                                @if (auth()->check())
                                                    <div class="reviews-bottom">
                                                        ...
                                                        <form action="{{ url('/review/store') }}" method="post">
                                                            ...
                                                            <div class="col-md-12">
                                                                <label>Message</label>
                                                                <textarea class="form-control" rows="5" name="message" placeholder="Enter your review message"></textarea>
                                                    ...
                                                    <div class="alert alert-danger">
                                                        <a href="{{ url('/user/login') }}" style="text-align: center; font-size: 24px; color: black; font-weight: 600">Login</a>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
